...
CHUNKING_STRATEGY = os.environ.get("CHUNKING_STRATEGY", "lexical")  # semantic, hybrid, lexical
SEMANTIC_CHUNK_SIZE = int(os.environ.get("SEMANTIC_CHUNK_SIZE", "1000"))
SEMANTIC_CHUNK_OVERLAP = int(os.environ.get("SEMANTIC_CHUNK_OVERLAP", "200"))
SEMANTIC_SIMILARITY_THRESHOLD = float(os.environ.get("SEMANTIC_SIMILARITY_THRESHOLD", "0.7"))
HYBRID_CHUNK_SIZE = int(os.environ.get("HYBRID_CHUNK_SIZE", "800"))
HYBRID_CHUNK_OVERLAP = int(os.environ.get("HYBRID_CHUNK_OVERLAP", "150"))
HYBRID_SEMANTIC_WEIGHT = float(os.environ.get("HYBRID_SEMANTIC_WEIGHT", "0.6"))
HYBRID_LEXICAL_WEIGHT = float(os.environ.get("HYBRID_LEXICAL_WEIGHT", "0.4"))
LEXICAL_CHUNK_SIZE = int(os.environ.get("LEXICAL_CHUNK_SIZE", "500"))
LEXICAL_CHUNK_OVERLAP = int(os.environ.get("LEXICAL_CHUNK_OVERLAP", "50"))
LEXICAL_CHUNK_BY = os.environ.get("LEXICAL_CHUNK_BY", "token")  # token, character, sentence
